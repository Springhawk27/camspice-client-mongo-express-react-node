...
const Navigation = () => {
  ...
  return (
    <header
      ...
      className="text-white body-font  bg-blue-500"
    >
        ...
        {user?.email ? (
          <div>
            ...
            <button
              onClick={logout}
              variant="light"
              className="inline-flex items-center bg-green-400 border-0 py-1 px-3 focus:outline-none hover:bg-green-500 rounded text-white mt-4 md:mt-0"
            >
              Logout
              <svg
                fill="none"
